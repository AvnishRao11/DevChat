    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
            <div className="bg-gray-900 shadow-lg rounded-lg p-8 w-full max-w-md">
                <h2 className="text-3xl font-bold text-white mb-6 text-center">Register to DevChat</h2>
                ...
                <div className="mt-6 text-center">
                    ...
                    <Link to="/login" className="ml-2 text-blue-500 hover:underline">Login</Link>
                </div>
            </div>
        </div>
    );
